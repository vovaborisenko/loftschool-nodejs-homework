...
<!-- Discont -->
      <div class="discont lazy" id="sendForm" data-src=" <?php echo get_template_directory_uri() ?>/img/bg_keys-in-door.png">
      ...
      <div class="slider locks">
        <div class="container slider__container">
          ...
          <div class="slider__wrap">
            <div class="slide"><a class="slide__link" href="#"><img class="slide__img" data-lazy=" <?php echo get_template_directory_uri() ?>/img/locks/lock_mottura.png">
                <div class="slide__head">Mottura</div>
                <div class="slide__text">Время замены 20 минут</div></a></div>
            <div class="slide"><a class="slide__link" href="#"><img class="slide__img" data-lazy=" <?php echo get_template_directory_uri() ?>/img/locks/lock_cisa.png">
                <div class="slide__head">Cisa</div>
                <div class="slide__text">Время замены 20 минут</div></a></div>
            <div class="slide"><a class="slide__link" href="#"><img class="slide__img" data-lazy=" <?php echo get_template_directory_uri() ?>/img/locks/lock_guardian.png">
...
<!-- Cars -->
      <div class="slider cars">
        <div class="container slider__container">
          ...
          <div class="slider__wrap">
            <div class="slide"><a class="slide__link" href="#"><img class="slide__img" data-lazy=" <?php echo get_template_directory_uri() ?>/img/cars/car_hyundai.png">
                <div class="slide__head"> <span class="nostrong">Hyundai </span>Cerato</div>
                <div class="slide__text">Время вскрытия 11 минут</div></a></div>
            <div class="slide"><a class="slide__link" href="#"><img class="slide__img" data-lazy=" <?php echo get_template_directory_uri() ?>/img/cars/car_bmw.png">
                <div class="slide__head"> <span class="nostrong">BMW </span>Series</div>
                <div class="slide__text">Время вскрытия 15 минут</div></a></div>
            <div class="slide"><a class="slide__link" href="#"><img class="slide__img" data-lazy=" <?php echo get_template_directory_uri() ?>/img/cars/car_mercedes.png">
      ...
      <div class="reviews">
        <div class="container reviews__container">
          ...
          <div class="reviews__wrap">
            <div class="review"><img class="review__photo lazy" data-src=" <?php echo get_template_directory_uri() ?>/img/avatars/avatar_1.png">
            ...
            <div class="review"><img class="review__photo lazy" data-src=" <?php echo get_template_directory_uri() ?>/img/avatars/avatar_2.png">
              <div class="review__name">Светлана Петрова</div>
              <div class="review__city">Москва</div>
              <div class="review__text">Вызывали мастера по вскрытию дверей. Работа была выполнена качественно и в срок. Будем обращаться и в дальнейшем.</div>
              <div class="review__date">21.12.2018</div>
            </div>
            <div class="review"><img class="review__photo lazy" data-src=" <?php echo get_template_directory_uri() ?>/img/avatars/avatar_3.png">
